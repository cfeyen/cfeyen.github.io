 ...
 * @returns {string}
 */
export function apply_rules(input, rules) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.apply_rules(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cscsca_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
